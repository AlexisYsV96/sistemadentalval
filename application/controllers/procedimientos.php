        ...
        if (!$this->logged()) {
            ...
            if (!$this->admin()) {
                ...
                if ($this->form_validation->run() == FALSE) {
                    ...
                    $procedimiento["procedimiento"] = array('id' => 'nomb_pro', 'name' => 'procedimiento', 'class' => "form-control", 'placeholder' => "Procedimiento", "maxlength" => "40", 'required' => 'true');
                    $procedimiento["cate"] = array('id' => 'nomb_cate', 'name' => 'nomb_cate', 'class' => "form-control", 'placeholder' => "Categorias", "maxlength" => "30", 'required' => 'true');
