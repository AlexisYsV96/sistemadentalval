...
class mod_procedimiento extends CI_Model {
    ...
    function get_procedimientos_xdescripcion(){
    ...
    function get_procedimientos_xdescripcion_count($q) { 
        $this->db->select('count(*)');
        $this->db->like('desc_pro', $q);
        $query = $this->db->get('vtarifa');
        $cnt = $query->row_array();
        return $cnt['count(*)'];
    } 
    ...
    function get_procedimientos_paginado($offset,$per_page){
    ...
    function get_procedimientos_count() {
