                ...
                <div id="panel-nueva-cita" class="login-panel panel panel-primary">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <?= form_dropdown('horario', array(), array(), 'class="form-control" required') ?>
                        </div>
                        <div class="form-group">
        ...
        $("select[name='medico']").change(function (e) { 
            ...
            $.ajax({
                ...
                success: function(resultado) {
                    ...
                    $("select[name='horario']").append($('<option>').val("").text("Seleccione una opción"));
                    $("select[name='horario']").find('option:not(:first)').remove();
                    for (const i in horarios) {
                        $("select[name='horario']").append($('<option>').val(horarios[i].codi_homed).text(horarios[i].fech_homed + " " + horarios[i].hora_homed))
                    }
                }
            });
        });
