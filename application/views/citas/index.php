                    ...
                    <table id="table-citas-medicas" class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th>Observación</th>
                                <th>Estado</th>
                                <th style="display: none">Motivo Consulta</th>
                                <th style="display: none">Síntomas</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            foreach ($citas as $row) {
                                ...
                                <tr class="<?= get_name_status_citas($row->esta_cit) ?>">
                                    ...
                                    <td style="text-align: center;"><?php
                                        ...
                                        ?></td>
                                        <td ><?=$row->obsv_cit ?></td>
                                   <!--  <td style="text-align: center;"><?php if($row->obsv_cit!="") { ?>
                                        <button type="button" class="btn btn-default btn-sm ver-observa"  data-toggle="tooltip" data-placement="top" title="" data-original-title="Ver observación"><i class="fa fa-eye-slash"></i></button><input type="hidden" value="<?= $row->obsv_cit ?>" class="txt-observa"><?php } ?></td> -->
                                    <td style="text-align: center;"><?= get_name_status_citas($row->esta_cit) ?></td>
                                    <td style="text-align: center; display: none "><?= $row->motivo_consult ?></td>
                                    <td style="text-align: center; display: none"><?= $row->sintomas ?></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
                    ...
                    <fieldset>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div id="error_hora_cita_edit" class="alert alert-danger alert-dismissable"
                                              ...
                                              <div class="form-group">
                                                <label>N° Cita: </label>
                                                <input type="text" name="codigo" value="" id="codigo_cit_edit" class="form-control" maxlength="50" required="true" autocomplete="off" readonly="true" style="width: 100px;">
                                            </div>
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="paciente" value="" id="paciente_cit_edit" class="form-control" maxlength="50" required="true" autocomplete="off" finalizarfinalizar>
                                            </div>
                                            <div class="form-group">
                                                <label>Motivo de la consulta: </label>
                                                <input type="text" name="motivoconsulta" value="" id="motivoconsulta" class="form-control" maxlength="50" required="true" autocomplete="off">
                                            </div>
                                            <div class="form-group">
                                                <label>Síntomas: </label>
                                                <input type="text" name="sintomas" value="" id="sintomas" class="form-control" maxlength="50" required="true" autocomplete="off">
                                            </div>
                                            <div class="form-group">
                                                <label>Observación: </label>
                                                <textarea name="observacion" cols="50" rows="2" id="observa_cit_edit" class="form-control" maxlength="125" autocomplete="off" style="max-width: 256px; max-height: 75px;"></textarea>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <div style="float: right;">
                                <button name="cancelar_editar_cita" type="button" class="btn btn-lg btn-danger" value="true" data-dismiss="modal">Cancelar</button>
                                <input type="submit" name="editar_cita_medica" value="Actualizar" class="btn btn-lg btn-success">
                            </div>
                        </div>
    ...
    <div class="modal-dialog" style="width: 30%;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?= ($admin || $doctor) ? form_button($comenzar_cita) : '' ?> 
                <?= form_button($reprogramar_cita) ?>
...
<!-- <div class="modal fade" id="ModalReprogramarCita" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none; top: 25%;">
...
<div class="modal fade" id="ModalReprogramarCita" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width: 30%;">
        <div class="modal-content panel panel-primary">
            <div class="modal-header panel-heading" style="text-align: center;">
                <h4 class="modal-title" id="myModalLabel">Reprogramar cita médica</h4>
            </div>
            <div id="frm_reprogramar_cita" class="panel-body"></div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content panel panel-primary">
            ...
            <div class="modal-body" style="overflow: scroll; height: 600px;">
                <div class="form-group">
                    ...
                    <select id="codigo_enf" class="form-control" name="codi_enf"> <?php foreach ($enfermedad as $row) { ?> <option value="<?= $row->codi_enf ?>"> <?= $row->codi_enf . ' - ' . $row->desc_enf ?> </option> <?php } ?> </select>
                    <br>
