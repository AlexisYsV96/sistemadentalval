            ...
            <div class="panel-body">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label>R.U.C.: *</label>
                        <?= form_input($ruc) ?>
                        <label class="text-danger" id="error_ruc_medico" style="display: none;">&nbsp;Carácter no válido</label>
                        <label class="text-danger" id="error_ruc_med_1" style="display: none;">&nbsp;Ya se encuentra asociado a otro médico</label>
                    </div>
                    <div class="form-group">
                        <label>Colegiatura: *</label>
                        <?= form_input($coleg) ?>
                        <label class="text-danger" id="error_coleg_medico" style="display: none;">&nbsp;Carácter no válido</label>
                        <label class="text-danger" id="error_coleg_med_1" style="display: none;">&nbsp;Ya se encuentra asociado a otro médico</label>
                    </div>
                    <div class="form-group">
