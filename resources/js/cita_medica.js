...
$(document).ready(function() {
    ...
    $('#table-citas-medicas').on('click', 'tbody tr', function() {
        ...
        paciente = $(this).find("td").eq(3).html();
...
*/
        ...
        if (estado == "Pendiente") {
            ...
            $('button[name="reprogramar_cita"]').css("display", "inherit");
    ...
    $('button[name="reprogramar_cita"').click(function() {

        $.ajax({
            url: base_url + 'citas/mostrar_formulario_reprogramar/'+ codigo,
            type: "GET",
            success: function(html) {
                $("#frm_reprogramar_cita").html(html);
    ...
    $("#editar_cita").click(function() {
        ...
        $('#citas-det tr').each(function() {
            if ($(this).find("td").eq(0).html() == codigo) {
                ...
                $("#motivoconsulta").val($(this).find("td").eq(6).html());
                $("#sintomas").val($(this).find("td").eq(7).html());
